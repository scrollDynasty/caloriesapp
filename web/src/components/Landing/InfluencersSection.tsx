...
export default function InfluencersSection() {
  const influencers = [
    ...
    {
      name: "Marcus Johnson",
      quote: "Yeb-Ich has completely changed how I track my nutrition. It's so simple and accurate, I can't imagine going back to manual logging.",
      imageUrl: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=800&h=1200&fit=crop",
    },
    {
      name: "Alex Rivera",
      quote: "The AI recognition in Yeb-Ich is incredible. Just snap a photo and get instant macro breakdowns. It's a game changer for meal prep.",
      imageUrl: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&h=1200&fit=crop",
    },
    {
      name: "Jordan Taylor",
      quote: "As a personal trainer, I recommend Yeb-Ich to all my clients. It makes calorie tracking effortless and helps them stay consistent.",
