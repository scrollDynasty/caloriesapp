...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: "Set personalized nutrition goals powered by AI. Get intelligent recommendations for your daily intake, track your progress, and optimize your diet based on your health objectives.",
    image: "/photo4.jpg",
  },
  {
  ...
  },
  {
    ...
    description: "Stay on top of your wellness journey. Track your daily water intake, log workouts, and monitor your activity levels. Yeb-Ich seamlessly integrates with your fitness routine to help you achieve your health goals.",
    image: "/photo3.jpg",
  },
];
...
export default function FeaturesSection() {
  ...
  const displayFeature = features.find((f) => f.id === activeFeature) || features[0];
